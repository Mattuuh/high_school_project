     ...
     @foreach($datosAsistencia as $asistencia)
                 <p>--------------------------------------------------------------------------------------------------------------------------</p>
                   <p style="text-align:right;">{{ $fechaInforme }}</p>
                    ...
                    registra a la fecha {{ $asistencia['faltas'] }} inasistencias. Por lo cual se encuentra en condicion libre.</p>
                    <p>Debe solicitar la reincorporacion y abonar el costo correspondiente.</p>
