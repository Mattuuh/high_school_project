...
@section('content')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <table class="table table-striped mt-1" id="tabla-tipos-empleado">
                    ...
                    <tbody>
                        @foreach ($tipos_empleado as $tipo_empleado)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('tipos_empleado.edit', $tipo_empleado->id) }}" class="btn btn-primary btn-sm">Editar</a>
                ...
                @include('panel.tipos_empleado.modals')
            </div>
        </div>
    </div>
    @else
...
@section('js')
    ...
    <script src="{{ asset('js/tipos_empleado.js') }}"></script>
